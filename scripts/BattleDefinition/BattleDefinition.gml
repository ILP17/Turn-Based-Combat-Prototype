global.monsters = {
	Weirdo: new Character({ name: "Weirdo", sprite: SprMonster, stats: new Stats({ hp: 25, at: 10, df: 2, sp: 3 }) }),
	Killer: new Character({ name: "Killer", sprite: SprAngryMonster, stats: new Stats({ hp: 15, at: 25, df: 3, sp: 2 }) }),
	Abhorrence: new Character({ name: "Abhorrence", sprite: SprAbhorrence, isBoss: true, stats: new Stats({ hp: 130, at: 38, df: 8, sp: 1 }) }),
	SassyWitch: new Character({
		name: "Sassy Witch",
...
global.playerParty = [
	...
	new Character({ name: "#1 Harpy Fan", stats: new Stats({ hp: 50, at: 28, df: 15, sp: 3 }) }),
	new Character({
		name: "Angel",
		sprite: SprHealer,
